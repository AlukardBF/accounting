...
-- Tue 12 Mar 2019 11:56:03 PM +04
...
CREATE TABLE IF NOT EXISTS `bachelor`.`material_value` (
  ...
  INDEX `fk_material_value_location_idx` (`location_location_id` ASC) VISIBLE,
  INDEX `fk_material_value_equipment_idx` (`equipment_equipment_id` ASC) VISIBLE,
  INDEX `fk_material_value_furniture_idx` (`furniture_furniture_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `bachelor`.`equipment_has_license` (
  ...
  INDEX `fk_equipment_has_license_license1_idx` (`license_license_id` ASC) VISIBLE,
  INDEX `fk_equipment_has_license_equipment1_idx` (`equipment_equipment_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `bachelor`.`specifications`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bachelor`.`specifications` (
...
-- -----------------------------------------------------
-- Table `bachelor`.`equipment_has_specifications`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bachelor`.`equipment_has_specifications` (
  `equipment_equipment_id` INT NOT NULL,
  `specifications_specifications_id` INT NOT NULL,
  `current_value` DOUBLE NOT NULL COMMENT 'Текущее значение характеристики',
  PRIMARY KEY (`equipment_equipment_id`, `specifications_specifications_id`),
  INDEX `fk_equipment_has_specifications_specifications1_idx` (`specifications_specifications_id` ASC) VISIBLE,
  INDEX `fk_equipment_has_specifications_equipment1_idx` (`equipment_equipment_id` ASC) VISIBLE,
  CONSTRAINT `fk_equipment_has_specifications_equipment1`
    FOREIGN KEY (`equipment_equipment_id`)
    REFERENCES `bachelor`.`equipment` (`equipment_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_equipment_has_specifications_specifications1`
    FOREIGN KEY (`specifications_specifications_id`)
    REFERENCES `bachelor`.`specifications` (`specifications_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
