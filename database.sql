...
CREATE TABLE IF NOT EXISTS `bachelor`.`furniture` (
  ...
  `material_value_material_value_id` INT NOT NULL,
  PRIMARY KEY (`furniture_id`, `material_value_material_value_id`),
  INDEX `fk_furniture_material_value1_idx` (`material_value_material_value_id` ASC),
  CONSTRAINT `fk_furniture_material_value1`
    FOREIGN KEY (`material_value_material_value_id`)
    REFERENCES `bachelor`.`material_value` (`material_value_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bachelor`.`equipment` (
  ...
  `material_value_material_value_id` INT NOT NULL,
  PRIMARY KEY (`equipment_id`, `material_value_material_value_id`),
  INDEX `fk_equipment_material_value1_idx` (`material_value_material_value_id` ASC),
  CONSTRAINT `fk_equipment_material_value1`
    FOREIGN KEY (`material_value_material_value_id`)
    REFERENCES `bachelor`.`material_value` (`material_value_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `bachelor`.`equipment_has_license` (
  ...
  `equipment_material_value_material_value_id` INT NOT NULL,
  `license_license_id` INT NOT NULL,
  PRIMARY KEY (`equipment_equipment_id`, `equipment_material_value_material_value_id`, `license_license_id`),
  INDEX `fk_equipment_has_license_license1_idx` (`license_license_id` ASC),
  INDEX `fk_equipment_has_license_equipment1_idx` (`equipment_equipment_id` ASC, `equipment_material_value_material_value_id` ASC),
  CONSTRAINT `fk_equipment_has_license_equipment1`
    FOREIGN KEY (`equipment_equipment_id` , `equipment_material_value_material_value_id`)
    REFERENCES `bachelor`.`equipment` (`equipment_id` , `material_value_material_value_id`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_equipment_has_license_license1`
