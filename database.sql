...
CREATE TABLE IF NOT EXISTS `bachelor`.`equipment_has_specifications` (
  ...
  INDEX `fk_equipment_has_specifications_specifications1_idx` (`specifications_specifications_id` ASC),
  INDEX `fk_equipment_has_specifications_equipment1_idx` (`equipment_equipment_id` ASC),
